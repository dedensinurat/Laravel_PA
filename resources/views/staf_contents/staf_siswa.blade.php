...
@section('contents')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" data-page-length='100' id="siswaTable{{ $kelas }}">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                    ...
                                    <tbody>
                                        @foreach ($siswas->sortBy('nama_lengkap') as $index => $siswa)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary mx-1" data-toggle="modal" data-target="#detailModal{{ $siswa->id_siswa }}" data-toggle="tooltip" title="Detail">
    ...
    <!-- Export PDF button placed outside the loop -->
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-md-6">
                <a href="#" onclick="event.preventDefault(); document.getElementById('export-pdf-form').submit();"
                    class="btn btn-danger btn-block">
                    <i class="fas fa-file-pdf"></i> Export PDF Semua Siswa
                </a>
                <form id="export-pdf-form" action="{{ route('students.exportPdfAll') }}" method="post"
                    style="display: none;">
                    @csrf
        ...
        $(document).ready(function() {
            ...
            $('[id^="siswaTable"]').each(function() {
                ...
                $(this).DataTable({
                    ...
                    dom: 'Bfrtip',
                    buttons: ['excel'],
                    // Use the table ID to dynamically set the button actions
